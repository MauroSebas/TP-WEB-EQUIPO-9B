...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="text-center mt-3 mb-4" style="color: var(--violeta-principal); font-size: 2.3rem; font-weight: 600; text-transform: none;">Formulario de participacion</h1>

    <div class="mb-3">
        <asp:Label ID="lblDni" AssociatedControlID="txtDni" runat="server" CssClass="form-label" Text="DNI"></asp:Label>
        <asp:TextBox ID="txtDni" runat="server" CssClass="form-control textbox-app mb-2" placeholder="Escribe tu DNI..." TextMode="Number"></asp:TextBox>
    ...
    <div class="row mb-3">
        ...
        <div class="col">
            ...
            <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control textbox-app mb-2" placeholder="E-mail" TextMode="Email"></asp:TextBox>
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <asp:TextBox ID="txtDireccion" CssClass="form-control textbox-app mb-2" placeholder="Apartment, studio, or floor" runat="server"></asp:TextBox>
        ...
        <div class="col">
            ...
            <asp:TextBox ID="txtCiudad" CssClass="form-control textbox-app mb-2" placeholder="Apartamento, estudio, o piso" runat="server"></asp:TextBox>
        ...
        <div class="col">
            ...
            <asp:TextBox ID="txtCp" CssClass="form-control textbox-app mb-2" placeholder="Código Postal" runat="server" TextMode="Number"></asp:TextBox>
